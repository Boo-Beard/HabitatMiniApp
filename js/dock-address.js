...
function renderDock(t, detectedChain) {
  ...
  if (socials.linkedin) links.push(`<a href="${socials.linkedin}" target="_blank" class="social-link"><i class="fa-brands fa-linkedin"></i></a>`);
  if (socials.discord) links.push(`<a href="${socials.discord}" target="_blank" class="social-link"><i class="fa-brands fa-discord"></i></a>`);
  ...
  const verifiedInlineHtml = verified && vStyle === 'inline'
    ? (function(){
        ...
        return '<span class="verified-inline" style="display:inline-flex;align-items:center;">'
             + '<i class="fa-solid fa-circle-check info-icon" style="color: var(--verified-color, #009bff); font-size:0.9em; margin-left:0px;" data-info="' + infoText.replace(/"/g,'&quot;') + '" aria-label="Verified" role="img"></i>'
             + '</span>';
      })()
    : '';
